...
public class Zoo {
    public static void main(String[] args) {
        ...
        boolean valueAvailable = collection1.contains(1);
        System.out.println("Is Value of 1 is available in collection1: "+ valueAvailable);
        ...
        System.out.println("Removing value of 2 from collection: " + collection1);
